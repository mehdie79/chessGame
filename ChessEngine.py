...
class GameState():
    def __init__(self) :
        ...
        self.moveFunctions = {'p': self.getPawnMoves, 'R': self.getRookMoves, 'B':self.getBishopMoves, 'N': self.getKnightMoves
                              , 'Q': self.getQueenMoves, 'K': self.getKingMoves}
        
        self.checkMate = False
        self.staleMate= False
        self.draw = False
        self.empassantPossible = () #cordinates for square where empassant is possible
        self.enpassantPossibleLog = [self.empassantPossible ]
    ...
    def makeMove(self, move):
        ...
        self.moveLog.append(move) # Log the move to keep track of moves
        ...
        self.enpassantPossibleLog.append(self.empassantPossible)
    ...
    def undoMove(self):
        ...
        if len(self.moveLog) != 0:
            ...
            self.empassantPossible = self.enpassantPossibleLog[-1]
    ...
    def checkDrawGame(self):
        for r in range(len(self.board)):
            for c in range(len(self.board[r])):
                ...
                if turn == "w" and piece != "K" and piece != "--":
                    return False
                if turn == "b" and piece != "K" and piece != "--":
                    return False
        return True
    ...
    def squareUnderAttack(self, r, c):
        self.whiteToMove = not self.whiteToMove # Opponents view
    ...
    def getRookMoves(self, r, c , moves):
        ...
        for d in directions:
            for i in range(1,8):
                ...
                if endRow >=0 and endRow < 8 and endColumn >=0 and endColumn < 8:
                    if self.board[endRow][endColumn] == "--":
                        moves.append(Move((r,c),(endRow,endColumn), self.board))
                    elif self.board[endRow][endColumn][0] == enemyPiece:
                        moves.append(Move((r,c),(endRow,endColumn), self.board))
                        break
                    else:
                        break
...
class Move():
    ...
    def __eq__ (self, other):
        ...
        if isinstance(other, Move):
            return (
                (int(self.startRow) == int(other.startRow)) and
                (int(self.startCol) == int(other.startCol)) and
                (int(self.endRow) == int(other.endRow)) and
                (int(self.endCol) == int(other.endCol))
            )
        else:
            return False   
